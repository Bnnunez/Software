...
class ProductPhotosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_photo" do
    assert_difference('ProductPhoto.count') do
      post product_photos_url, params: { product_photo: { product_id: @product_photo.product_id } }
    end
  ...
  test "should update product_photo" do
    patch product_photo_url(@product_photo), params: { product_photo: { product_id: @product_photo.product_id } }
