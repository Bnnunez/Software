...
class PetPhotosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pet_photo" do
    assert_difference('PetPhoto.count') do
      post pet_photos_url, params: { pet_photo: { adoption_pet_id: @pet_photo.adoption_pet_id } }
    end
  ...
  test "should update pet_photo" do
    patch pet_photo_url(@pet_photo), params: { pet_photo: { adoption_pet_id: @pet_photo.adoption_pet_id } }
